...
export interface SqlRequestReply {
     ...
     */
    createdAt: bigint; // @gotags: gorm:"autoCreateTime:milli"}
/**
...
export interface MethodMetric {
     ...
     */
    startedTime: bigint; // @gotags: bson:"startedTime"    /**
     * @generated from protobuf field: int64 endTime = 4
     */
    endTime: bigint; // @gotags: bson:"endTime"    /**
     * @generated from protobuf field: int64 numberOfCalls = 5
     */
    numberOfCalls: bigint; // @gotags: bson:"numberOfCalls"    /**
     ...
     */
    sumDuration: bigint; // @gotags: bson:"sumDuration"    /**
     * @generated from protobuf field: int64 minDuration = 8
     */
    minDuration: bigint; // @gotags: bson:"minDuration"    /**
     * @generated from protobuf field: int64 maxDuration = 9
     */
    maxDuration: bigint; // @gotags: bson:"maxDuration"    /**
     * @generated from protobuf field: int64 lastUpdate = 10
     */
    lastUpdate: bigint; // @gotags: bson:"lastUpdate"    /**
...
export interface Comment {
     ...
     */
    iD: bigint; // @gotags: gorm:"primaryKey;autoIncrement"    /**
     * @generated from protobuf field: int64 createdDate = 2
     */
    createdDate: bigint; // @gotags: gorm:"autoCreateTime:milli"    /**
...
class SqlRequestReply$Type extends MessageType<SqlRequestReply> {
    constructor() {
        super("SqlRequestReply", [
            ...
            { no: 13, name: "createdAt", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ }
        ]);
    }
...
class MethodMetric$Type extends MessageType<MethodMetric> {
    constructor() {
        super("MethodMetric", [
            ...
            { no: 3, name: "startedTime", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 4, name: "endTime", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 5, name: "numberOfCalls", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 6, name: "avgDuration", kind: "scalar", T: 2 /*ScalarType.FLOAT*/ },
            { no: 7, name: "sumDuration", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 8, name: "minDuration", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 9, name: "maxDuration", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 10, name: "lastUpdate", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ },
    ...
    create(value?: PartialMessage<MethodMetric>): MethodMetric {
        ...
        message.startedTime = 0n;
        message.endTime = 0n;
        message.numberOfCalls = 0n;
        message.avgDuration = 0;
        message.sumDuration = 0n;
        message.minDuration = 0n;
...
class ServiceInformation$Type extends MessageType<ServiceInformation> {
    constructor() {
        super("ServiceInformation", [
            ...
            { no: 6, name: "startedTime", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ },
...
class Comment$Type extends MessageType<Comment> {
    constructor() {
        super("Comment", [
            ...
            { no: 2, name: "createdDate", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ },
